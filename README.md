...
Step 1. [Download the latest release](https://github.com/Asenar/less.php/releases) and upload the php files to your server.
...
Step 1. [Download the source](https://github.com/Asenar/less.php/archive/master.zip) and upload the files in /lib/Less to a folder on your server.
...
1. [Download the less.php source code](https://github.com/Asenar/less.php/archive/master.zip) and unzip it so that 'lessc.inc.php' is located at 'sites/all/libraries/lessphp/lessc.inc.php'.
...
---
Projects looking for an easy transition from leafo/lessphp can use the lessc.inc.php adapter. To use, [Download the less.php source code](https://github.com/Asenar/less.php/archive/master.zip) and unzip the files into your project so that the new 'lessc.inc.php' replaces the existing 'lessc.inc.php'.

Note, the 'setPreserveComments' will no longer have any effect on the compiled less.

Credits
---
less.php was originally ported to php by [Matt Agar](https://github.com/agar) then updated by [Martin Jantošovič](https://github.com/Mordred) and then updated by [Josh Schmidt](https://github.com/oyejorge).
